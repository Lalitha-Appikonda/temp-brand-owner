  ...
  return (
    <>
      <div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "100px", marginTop: "50px" }}>
          {colors.map((color) => (
            <div key={color.name} style={{ textAlign: "center" }}>
              <div style={{ width: "100px", height: "100px", border: "2px solid black", borderRadius: "50%", background: color.bg, }}></div>
              <p>{color.name}</p>
            </div>
          ))}
        </div>
      ...
      <div style={{ textAlign: "center", margin: "40px" }} >
        ...
        <p style={{ fontFamily: "creatodisplay-regular" }}>creato-display-regular-fontweight:"400"</p>
        <p style={{ fontFamily: "creatodisplay-medium" }}>creato-display-medium-fontweight:"500"</p>
        <p style={{ fontFamily: "creatodisplay-bold" }}>creato-display-bold-fontweight:"700"</p>
